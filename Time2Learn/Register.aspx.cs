    ...
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (spaceIdx > 0)
                {
                    lastName = fullName.Substring(0, spaceIdx).Trim();
                    firstName = fullName.Substring(spaceIdx + 1).Trim();
                }
                else
                {
                    firstName = fullName;
                ...
                string insertSql = @"INSERT INTO Users (FirstName, LastName, Email, PasswordHash, RoleID, Avatar, AccountStatus, RegistrationDate) VALUES (@FirstName, @LastName, @Email, @PasswordHash, @RoleID, @Avatar, 'Active', GETDATE()); SELECT SCOPE_IDENTITY();";
            ...
            {
                lblError.Text = "Unable to complete registration. Please try again later.";
                lblError.Visible = true;
            }
        }
    }
