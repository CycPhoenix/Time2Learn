                                    ...
                                    <tr data-name="<%# (Eval("FirstName").ToString() + " " + Eval("LastName").ToString()).ToLower() %>" data-progress="<%# Eval("OverallProgressPercentage") %>">
                                        ...
                                        <td>
                                            <div style="display:flex;align-items:center;gap:8px;">
                                                <div class="prog-bar-wrap"><div class="prog-bar" style="<%# string.Format("width:{0}%;{1}", Eval("OverallProgressPercentage"), Convert.ToDouble(Eval("OverallProgressPercentage")) >= 100 ? "background:#22c55e;" : "") %>"></div></div>
