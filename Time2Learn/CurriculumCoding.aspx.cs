...
{
    public partial class CurriculumCoding : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            DataTable q = DBHelper.ExecuteQuery("SELECT TOP 1 QuestionPrompt, StarterCode FROM Question WHERE LessonID = @LID",
                new System.Data.SqlClient.SqlParameter[]
                {
                    new System.Data.SqlClient.SqlParameter("@LID", _lessonID)
                });
            ...
            if (q.Rows.Count > 0)
            {
                ...
                {
                    litProblem.Text = "Complete the coding exercise for this lesson.";
                }
        ...
        protected void btnSubmitCode_Click(object sender, EventArgs e)
        {
            ...
            {
                lblMsg.Text = "Please write your solution before submitting.";
            ...
            lblMsg.Text = "Solution submitted! Exercise marked as complete.";
