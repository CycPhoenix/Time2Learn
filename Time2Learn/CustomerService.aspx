    ...
    <div class="dashboard-layout">
        ...
        <aside class="dash-sidebar">
            ...
            <nav class="sidebar__nav">
                ...
                <div class="sidebar__nav-item" id="nav-profile" onclick="showCSSection('profile', this)">
                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                    My Profile
                </div>
                <div class="sidebar__nav-item" id="nav-settings" onclick="showCSSection('settings', this)">
        ...
        <main class="dashboard-content">
            ...
            <div class="inst-section" id="section-faq">
                ...
                <asp:Panel ID="pnlFaqForm" runat="server" Visible="false" CssClass="admin-table-wrap" style="padding:20px;margin-bottom:20px;">
                    ...
                    <asp:Label ID="lblFaqMsg" runat="server" style="display:block;margin-top:8px;font-size:0.85rem;" />
                </asp:Panel>
            ...
            <div class="inst-section" id="section-chatbot">
                ...
                <div class="tab-panel" id="chatbot-tab-kb">
                    <asp:Panel ID="pnlKBForm" runat="server" Visible="false" CssClass="admin-table-wrap" style="padding:20px;margin-bottom:20px;">
                        ...
                        <asp:Label ID="lblKBMsg" runat="server" style="display:block;margin-top:8px;font-size:0.85rem;" />
                    </asp:Panel>
